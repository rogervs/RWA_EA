...
setup = [
    # (admin, "add Inspect room 6-1"),
    # (admin, "add Inspect room 5-2"),
    # (admin, "add Inspect room 7-3"),
    # (admin, "add Inspect room 3-8"),
    # (admin, "open")
...
print("Tasks:")
print("admin: add stuff")
print("admin: open")
print("clare: Demo 2")
print(f"clare: {clare_eth_addr}")
